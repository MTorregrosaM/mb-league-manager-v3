  ...
  try {
    ...
    */
    ...
    /********************************/
      ...
      if (isset($_POST["guardarUsuario"]) && $fIdUsuarioEditar != null){
        ...
        */
        ...
        $mensajeAltaMod .= "<div id=\"". ( ($comprobarAltaMod == 1)? "mensaje-ok" : (($comprobarAltaMod == 3)? "mensaje-aviso" : "mensaje-error")) ."\">".
                ( ($comprobarAltaMod == 1)? "Usuario modificado correctamente.  <a href=\"#\"  class=\"btnVolver\">Volver</a>" :
                  (($comprobarAltaMod == 2)? "Se ha producido un error en su solicitud." : (($comprobarAltaMod == 3)? "AVISO: debe modificar al menos un campo." : "Se ha producido un error en su solicitud.")) ) ."</div>";
...
<div id="contenedor-principal">
  ...
  <div id="form">
    ...
    <form name="btnAltaUsuario" id="btnAltaUsuario" method="POST" action="" >
      ...
      <?php if ($accionForm == 4){ ?>
        <input type="hidden" name="fIdUsuarioEditar" id="fIdUsuarioEditar" value="<?php printf($fIdUsuario);?>"/>
        <input type="hidden" name="guardarUsuario" id="guardarUsuario" value="1"/>
      <?php } ?>
      ...
      <p><label for="fNick">Nick: </label>  <input type="text" name="fNick" maxlength="35"  id="fNick" data-validation="required " value="<?php printf($fNick);?>"  ></p>
        <p><label for="fPass">Contraseña: </label>  <input type="password" name="fPass" maxlength="35"  id="fPass" value="<?php printf(($accionForm == 4)? '' : htmlspecialchars($fPass, ENT_QUOTES, 'UTF-8'));?>" autocomplete="new-password"></p>
