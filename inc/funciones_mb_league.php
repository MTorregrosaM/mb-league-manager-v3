<?php
    ...
    function formatoFecha ( $fFecha, $utcUsa = true ){
    ...
    // pintamos la tabla de cruces de cada ronda
    function pintarTablaCruces($idLiga, $numFase, $numRonda){
        ...
        WHERE t1.idLiga = " . $idLiga . " AND t1.numFase = " . $numFase . " AND t1.numRonda = " . $numRonda . " ORDER BY idJugador2";
    ...
    while ($filaRonda = mysqli_fetch_assoc($resultadoBDRonda)) {
           ...
           printf("<tr><td class=\"faseFuentePeq\">" . formatoFecha ($fechaBatalla, false) . "</td><td>" . $filaRonda["nickJugador1"] . "</td><td>" . $filaRonda["nickJugador2"] . "</td><td class=\"faseFuentePeq\">" . $filaRonda["resultadoJugador1"] . "-" . $filaRonda["resultadoJugador2"] . "</td></tr>");
