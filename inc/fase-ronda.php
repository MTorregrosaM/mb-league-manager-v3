...
function formatoFecha1( $utcUsa = true, $fFecha ){
 ...
 function printFaseRonda ( $idLiga, $idFase, $idRonda ){
    ...
    WHERE t1.idLiga = " . $idLiga . " AND t1.numFase = " . $idFase ." AND t1.numRonda = " . $idRonda . " ORDER BY idJugador2";
    ...
    $resultadoBDRonda = $conexion-> query( $queryRonda );
        ...
        while ($filaRonda = mysqli_fetch_assoc($resultadoBDRonda)) {
            ...
            printf("<tr><td class=\"faseFuentePeq\">" 
            . formatoFecha1 (false, $fechaBatalla) 
            . "</td><td>" 
            . $filaRonda["nickJugador1"] . "</td><td>" 
            . $filaRonda["nickJugador2"] 
             . "</td><td class=\"faseFuentePeq\">" 
             . $filaRonda["resultadoJugador1"] . "-" 
             . $filaRonda["resultadoJugador2"] . "</td></tr>");
