    ...
    mysqli_set_charset($link, 'utf8');
       ...
       echo $query = "SELECT distinct idJugador, nick, T2.descFaccion, T2.imgFaccion FROM mb_jugadores T1 INNER JOIN mb_facciones T2 on T1.bando = T2.idFaccion AND idLiga = " . $idLiga . " and nick !=  'zMercenario' order by idJugador";                
        $resultadoBD = mysqli_query($link, $query);
