...
<?php
  ...
  try {
    ...
    if ($accionForm == 1 && $tockenEnvio == 0 ) {
      ...
      $comprobarAlta = $oControllerEnfrentamiento->altaResultadoEnfrentamientoResumido( $fIdLiga, $fIdJugador1, $fIdJugador2, $fFechaBatalla, $fResultadoJugador1, $fResultadoJugador2, $fValPintura,  $fValDeportividad );
      /*  1. OK
        2. ERROR
        3. AVISO 
      */ 

  printf( $fIdLiga . "." . $fIdJugador1  . "." .$fIdJugador2  . "." . $fFechaBatalla . "." . $fResultadoJugador1  . "." . $fResultadoJugador2   . "." . $fValPintura   . "." .  $fValDeportividad  );
  ...
  <?php if($auxClaveCorrecta){ ?>
    ...
    <div id="form">
        ...
        <form name="altaResultado" id="altaResultado" method="POST" action="" enctype="multipart/form-data">
          ...
          <p><label for="fIdJugador2">Tu contrincante: </label><span id="selectJugadores2" name="selectJugadores2"><select name="fIdJugador2" id="fIdJugador2" data-validation="required " ><option value=""></option><?php printf($selectJugadores); ?> </select></span></p>
          ...
          <div class="resultados">
            ...
            <?php if ($oLiga->idJuego <= 2 || $oLiga->idJuego == 5) {?>
              ...
              <div class="resultados-dec">
                ...
                <p id="enfrentamientoJug2" ><?php printf($fIdJugador2);?></p>
            ...
            <?php if ($fIdLiga != 0 && $oLiga->idJuego <= 2 && (isset($_SESSION["autorizado"]) && $_SESSION["autorizado"] == 1)) {  // SOLO FLAMES OF WAR?>
            <p><br/>
...
<script>  
    ...
    $(function(){
      ...
      <?php if($fClaveCifrada != null && $auxClaveCorrecta == true){ ?>
                ...
                $("#enfrentamientoJug2").text( $('#fIdJugador2 option:selected').text())
                ...
                $("#fIdJugador2").change(function(){ 
                  if ($('#fIdJugador2 option:selected').val() != null && $('#fIdJugador2 option:selected').val() != 0){
                   
                    if ( $('#fIdJugador2 option:selected').val() > 0){
                      $("#enfrentamientoJug2").text( $('#fIdJugador2 option:selected').text());
                    }else{
                      $("#enfrentamientoJug2").text( "Jugador 2");
                    }
                  }
          ...
          $.ajax({
              async: true,
                  ...
                  success:  function (response) {
                          ...
                          $("#enfrentamientoJug2").text( $('#fIdJugador2').val() );
