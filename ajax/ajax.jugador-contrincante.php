<?php
        ...
        // FASES
        if ($fIdJugador1 == null) {
            echo "\n<input type=\"text\" id=\"fIdJugador2Nick\" name=\"fIdJugador2Nick\" value=\"Jugador 2\" style=\"background: red !important; color: white !important\" style=\"background: #EEE\" disabled/>";
        }else{
            ...
            if (is_array($arrJugadores) && count($arrJugadores) >= 1 ){
                ...
                echo "\n<input type=\"text\" id=\"fIdJugador2Nick\" name=\"fIdJugador2Nick\" value=\"" . $arrJugadores[3] . "\" readonly style=\"background: #EEE\"/>";
                ...
                echo "\n<input type=\"text\" id=\"fIdJugador2Nick\" name=\"fIdJugador2Nick\" value=\"&nbsp;\" style=\"background: #EEE\" disabled/>";
            }
